...
<body>
	<nav class="navbar navbar-inverse" style="background-color: #1c2833;">
      ...
      <img src="Logo.png" height="25" alt="logo">
		...
		<ul class="navbar-nav">
			<li class="nav-item h4">JSON Beautifier</li>
		</ul>
	</nav>
	...
	<div class="row no-gutters">
		...
		<div class="col-md-2 no-gutters">
			<div class="middle d-flex justify-content-center align-items-center">
				<div>
					<button id="format" class="btn btn-md btn-success">FORMAT
					</button>
				</div>
			</div>
		</div>
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/codemirror.js"></script>
	<script
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/jquery.json-editor.min.js"></script>
	...
	<script>
		...
		function getJson() {
			try {
				...
				return json_format.parse(json.getValue());
